  ...
  return [
    {
      ...
      sla_breached: false,
      sla_due_at: new Date(now.getTime() + 1 * 24 * 60 * 60 * 1000).toISOString(),
      first_response_at: new Date(now.getTime() - 2 * 24 * 60 * 60 * 1000).toISOString(),
      escalation_level: 1,
      priority: 'urgent',
      affected_resources: ['arn:aws:s3:::demo-app-uploads'],
      automation_available: true,
      estimated_effort_hours: 2,
      business_impact: 'Exposição de dados sensíveis de clientes à internet pública',
    ...
    },
    {
      ...
      sla_breached: false,
      sla_due_at: new Date(now.getTime() + 3 * 24 * 60 * 60 * 1000).toISOString(),
      first_response_at: null,
      escalation_level: 0,
      priority: 'high',
      affected_resources: ['arn:aws:iam::123456789012:user/deploy-service'],
      automation_available: true,
      estimated_effort_hours: 1,
      business_impact: 'Credenciais comprometidas podem dar acesso não autorizado à conta AWS',
      resolution_notes: null,
    ...
    },
    {
      ...
      sla_breached: false,
      sla_due_at: new Date(now.getTime() + 5 * 24 * 60 * 60 * 1000).toISOString(),
      first_response_at: new Date(now.getTime() - 1 * 24 * 60 * 60 * 1000).toISOString(),
      escalation_level: 0,
      priority: 'high',
      affected_resources: ['i-0abc123def456789', 'i-0def456abc789012', 'i-0789abc012def345'],
      automation_available: false,
      estimated_effort_hours: 8,
      business_impact: 'Dados em repouso sem criptografia violam LGPD e PCI-DSS',
      resolution_notes: null,
    ...
    },
    {
      ...
      sla_breached: false,
      sla_due_at: new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000).toISOString(),
      first_response_at: new Date(now.getTime() - 9 * 24 * 60 * 60 * 1000).toISOString(),
      escalation_level: 0,
      priority: 'medium',
      affected_resources: ['arn:aws:rds:us-east-1:123456789012:db:demo-prod-db'],
      automation_available: true,
      estimated_effort_hours: 1,
      business_impact: 'Risco de indisponibilidade em caso de falha na AZ primária',
      resolution_notes: 'Multi-AZ habilitado com sucesso. Failover testado e validado.',
    ...
    },
    {
      ...
      sla_breached: false,
      sla_due_at: new Date(now.getTime() + 10 * 24 * 60 * 60 * 1000).toISOString(),
      first_response_at: null,
      escalation_level: 0,
      priority: 'medium',
      affected_resources: ['i-0111222333444555', 'i-0222333444555666', 'i-0333444555666777', 'i-0444555666777888', 'i-0555666777888999'],
      automation_available: true,
      estimated_effort_hours: 4,
      business_impact: 'Custo desnecessário de $450/mês com instâncias ociosas',
      resolution_notes: null,
    ...
    },
    {
      ...
      due_date: new Date(now.getTime() - 5 * 24 * 60 * 60 * 1000).toISOString(),
      sla_breached: false,
      sla_due_at: new Date(now.getTime() - 8 * 24 * 60 * 60 * 1000).toISOString(),
      first_response_at: new Date(now.getTime() - 14 * 24 * 60 * 60 * 1000).toISOString(),
      escalation_level: 0,
      priority: 'urgent',
      affected_resources: ['sg-0abc123def456'],
      automation_available: true,
      estimated_effort_hours: 1,
      business_impact: 'Instâncias expostas a ataques de brute force SSH da internet',
      resolution_notes: 'Regra 0.0.0.0/0 removida. Acesso SSH restrito ao bastion host. Session Manager configurado como alternativa.',
...
export function generateDemoKbAnalytics() {
  return {
    ...
    totalHelpful: 231,
    recentArticles: 3,
    // Fields used by kb-analytics-dashboard handler response
    topArticles: [
    ...
    // Fields used by AnalyticsDashboard.tsx frontend component
    mostViewed: [
      { title: 'Resposta a Incidentes', view_count: 312 },
      { title: 'Checklist LGPD', view_count: 278 },
      { title: 'MFA para IAM Users', view_count: 234 },
      { title: 'Otimização EC2', view_count: 189 },
      { title: 'WAF contra SQLi', view_count: 156 },
    ],
    ...
    topAuthors: [
      { email: 'admin@demo.com', article_count: 2 },
      { email: 'security-lead@demo.com', article_count: 2 },
      { email: 'devops@demo.com', article_count: 1 },
    ],
    completionRate: { completed_reads: 847 },
    totalEngagements: { helpful: 231, shares: 89 },
  };
}
...
export function generateDemoCloudTrailEventsTable() {
  ...
  const events = [
    { event_name: 'ConsoleLogin', user_name: 'admin@demo.com', user_type: 'IAMUser', risk_level: 'low', source_ip_address: '203.0.113.50', aws_region: 'us-east-1', event_source: 'signin.amazonaws.com', error_code: null },
    { event_name: 'CreateAccessKey', user_name: 'deploy-bot', user_type: 'IAMUser', risk_level: 'high', source_ip_address: '198.51.100.25', aws_region: 'us-east-1', event_source: 'iam.amazonaws.com', error_code: null },
    { event_name: 'AuthorizeSecurityGroupIngress', user_name: 'dev-user', user_type: 'IAMUser', risk_level: 'high', source_ip_address: '192.0.2.100', aws_region: 'us-east-1', event_source: 'ec2.amazonaws.com', error_code: null },
    { event_name: 'PutBucketPolicy', user_name: 'admin@demo.com', user_type: 'IAMUser', risk_level: 'medium', source_ip_address: '203.0.113.50', aws_region: 'us-east-1', event_source: 's3.amazonaws.com', error_code: null },
    { event_name: 'StopInstances', user_name: 'ops-user', user_type: 'IAMUser', risk_level: 'low', source_ip_address: '198.51.100.75', aws_region: 'us-east-1', event_source: 'ec2.amazonaws.com', error_code: null },
    { event_name: 'DeleteBucket', user_name: 'unknown-user', user_type: 'Root', risk_level: 'critical', source_ip_address: '10.0.0.1', aws_region: 'us-east-1', event_source: 's3.amazonaws.com', error_code: 'AccessDenied' },
    { event_name: 'RunInstances', user_name: 'auto-scaling', user_type: 'AssumedRole', risk_level: 'low', source_ip_address: null, aws_region: 'us-east-1', event_source: 'ec2.amazonaws.com', error_code: null },
    { event_name: 'AttachUserPolicy', user_name: 'admin@demo.com', user_type: 'IAMUser', risk_level: 'high', source_ip_address: '203.0.113.50', aws_region: 'us-east-1', event_source: 'iam.amazonaws.com', error_code: null },
    { event_name: 'ModifyDBInstance', user_name: 'dba-user', user_type: 'IAMUser', risk_level: 'medium', source_ip_address: '192.0.2.200', aws_region: 'us-east-1', event_source: 'rds.amazonaws.com', error_code: null },
    { event_name: 'AssumeRole', user_name: 'external-auditor', user_type: 'FederatedUser', risk_level: 'medium', source_ip_address: '198.51.100.150', aws_region: 'us-east-1', event_source: 'sts.amazonaws.com', error_code: null },
  ];
...
/**
 * Gera dados de security_scans para query-table (formato Prisma model)
 * Usado quando SecurityScanDetails.tsx busca scan por ID via apiClient.select('security_scans')
 */
export function generateDemoSecurityScansTable() {
  const now = new Date();
  const DEMO_ORG_ID = 'demo-organization-id';
  ...
  return [
    {
      ...
      aws_account_id: 'demo-account',
      cloud_provider: 'AWS',
      azure_credential_id: null,
      scan_type: 'deep',
      status: 'completed',
      scan_config: { level: 'deep', frameworks: ['CIS', 'LGPD', 'PCI-DSS'], engine: 'v3' },
      results: { duration_ms: 45200, services_scanned: 23, regions_scanned: 4, checks_performed: 170, engine_version: '3.0.1' },
      findings_count: 30,
      critical_count: 2,
      high_count: 5,
      medium_count: 8,
    ...
    },
    {
      ...
      scan_type: 'standard',
      status: 'completed',
      scan_config: { level: 'standard', frameworks: ['CIS'], engine: 'v3' },
      results: { duration_ms: 32100, services_scanned: 15, regions_scanned: 2, checks_performed: 95, engine_version: '3.0.1' },
      findings_count: 25,
      critical_count: 1,
      high_count: 4,
      medium_count: 10,
    ...
    },
    {
      ...
      scan_type: 'quick',
      status: 'completed',
      scan_config: { level: 'quick', engine: 'v3' },
      results: { duration_ms: 12800, services_scanned: 8, regions_scanned: 1, checks_performed: 45, engine_version: '3.0.1' },
      findings_count: 18,
      critical_count: 2,
      high_count: 3,
      medium_count: 6,
...
/**
 * Gera dados de findings para query-table (formato Prisma Finding model)
 * Usado quando SecurityScanDetails.tsx busca findings via apiClient.select('findings')
 */
export function generateDemoFindingsTable() {
  const now = new Date();
  const DEMO_ORG_ID = 'demo-organization-id';
  ...
  return [
    {
      ...
      severity: 'critical',
      title: 'S3 Bucket com acesso público',
      description: 'O bucket demo-company-data está configurado com acesso público, expondo dados sensíveis à internet.',
      resource_id: 'demo-company-data',
      resource_type: 'AWS::S3::Bucket',
      region: 'us-east-1',
      resource_arn: 'arn:aws:s3:::demo-company-data',
      details: { check_name: 'S3 Bucket Public Access', resource_type: 'S3', region: 'us-east-1' },
      status: 'open',
      source: 'security-engine',
      scan_type: 'deep',
      service: 'S3',
      category: 'Data Protection',
      compliance: ['CIS 2.1.1', 'LGPD Art. 46', 'PCI-DSS 3.4'],
      remediation: 'Remover a política de acesso público e habilitar Block Public Access em todas as configurações do bucket.',
      risk_vector: 'network/public-exposure',
      evidence: { public_acl: true, block_public_access: false, policy_allows_public: true },
    ...
    },
    {
      ...
      azure_credential_id: null,
      severity: 'critical',
      title: 'Root account sem MFA habilitado',
      description: 'A conta root da AWS não possui autenticação multifator (MFA) habilitada, representando risco crítico de segurança.',
      resource_id: 'root-account',
      resource_type: 'AWS::IAM::User',
      region: 'global',
      resource_arn: 'arn:aws:iam::123456789012:root',
      details: { check_name: 'Root Account MFA', resource_type: 'IAM', region: 'global' },
      status: 'open',
      source: 'security-engine',
      scan_type: 'deep',
      service: 'IAM',
      category: 'Identity & Access',
      compliance: ['CIS 1.5', 'NIST AC-2', 'PCI-DSS 8.3'],
      remediation: 'Habilitar MFA virtual ou hardware na conta root. Acessar IAM > Security credentials > Assign MFA device.',
      risk_vector: 'identity/root-access',
      evidence: { mfa_enabled: false, last_login: new Date(now.getTime() - 5 * 24 * 60 * 60 * 1000).toISOString() },
      remediation_ticket_id: null,
      created_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      updated_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      _isDemo: true,
    },
    {
      ...
      severity: 'high',
      title: 'Security Group permite acesso SSH de qualquer IP',
      description: 'O Security Group sg-demo-web permite conexões SSH (porta 22) de 0.0.0.0/0, expondo instâncias a ataques de brute force.',
      resource_id: 'sg-demo-web',
      resource_type: 'AWS::EC2::SecurityGroup',
      region: 'us-east-1',
      resource_arn: 'arn:aws:ec2:us-east-1:123456789012:security-group/sg-demo-web',
      details: { check_name: 'Security Group Open SSH', resource_type: 'EC2', region: 'us-east-1', port: 22, cidr: '0.0.0.0/0' },
      status: 'open',
      source: 'security-engine',
      scan_type: 'deep',
      service: 'EC2',
      category: 'Network Security',
      compliance: ['CIS 5.2', 'NIST SC-7', 'PCI-DSS 1.3'],
      remediation: 'Restringir o acesso SSH apenas a IPs conhecidos ou usar AWS Systems Manager Session Manager.',
      risk_vector: 'network/open-port',
      evidence: { inbound_rules: [{ port: 22, protocol: 'tcp', source: '0.0.0.0/0' }] },
      remediation_ticket_id: null,
      created_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      updated_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      _isDemo: true,
    },
    {
      ...
      severity: 'high',
      title: 'RDS sem criptografia habilitada',
      description: 'A instância RDS demo-database não possui criptografia at-rest habilitada, violando requisitos de compliance.',
      resource_id: 'demo-database',
      resource_type: 'AWS::RDS::DBInstance',
      region: 'us-east-1',
      resource_arn: 'arn:aws:rds:us-east-1:123456789012:db:demo-database',
      details: { check_name: 'RDS Encryption at Rest', resource_type: 'RDS', region: 'us-east-1' },
      status: 'open',
      source: 'security-engine',
      scan_type: 'deep',
      service: 'RDS',
      category: 'Data Protection',
      compliance: ['CIS 2.3.1', 'LGPD Art. 46', 'PCI-DSS 3.4'],
      remediation: 'Criar um snapshot criptografado e restaurar a instância a partir dele. Habilitar criptografia padrão para novas instâncias.',
      risk_vector: 'data/unencrypted-storage',
      evidence: { storage_encrypted: false, engine: 'postgres', instance_class: 'db.t3.medium' },
      remediation_ticket_id: null,
      created_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      updated_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      _isDemo: true,
    },
    {
      ...
      azure_credential_id: null,
      severity: 'high',
      title: 'EBS volumes sem criptografia',
      description: '3 volumes EBS em produção não possuem criptografia habilitada.',
      resource_id: 'vol-demo-data',
      resource_type: 'AWS::EC2::Volume',
      region: 'us-east-1',
      resource_arn: 'arn:aws:ec2:us-east-1:123456789012:volume/vol-demo-data',
      details: { check_name: 'EBS Volume Encryption', resource_type: 'EC2', region: 'us-east-1' },
      status: 'open',
      source: 'security-engine',
      scan_type: 'deep',
      service: 'EC2',
      category: 'Data Protection',
      compliance: ['CIS 2.2.1', 'LGPD Art. 46'],
      remediation: 'Criar snapshots dos volumes, criar novos volumes criptografados a partir dos snapshots e substituir os volumes originais.',
      risk_vector: 'data/unencrypted-storage',
      evidence: { encrypted: false, size_gb: 100, state: 'in-use' },
      remediation_ticket_id: null,
      created_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      updated_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      _isDemo: true,
    },
    {
      ...
      severity: 'medium',
      title: 'CloudTrail não está habilitado em todas as regiões',
      description: 'O CloudTrail está configurado apenas para us-east-1, deixando outras regiões sem auditoria de eventos.',
      resource_id: 'demo-trail',
      resource_type: 'AWS::CloudTrail::Trail',
      region: 'us-east-1',
      resource_arn: 'arn:aws:cloudtrail:us-east-1:123456789012:trail/demo-trail',
      details: { check_name: 'CloudTrail Multi-Region', resource_type: 'CloudTrail', region: 'us-east-1' },
      status: 'open',
      source: 'security-engine',
      scan_type: 'deep',
      service: 'CloudTrail',
      category: 'Logging & Monitoring',
      compliance: ['CIS 3.1', 'NIST AU-2', 'SOC2 CC7.2'],
      remediation: 'Habilitar CloudTrail multi-região para capturar eventos em todas as regiões AWS.',
      risk_vector: 'logging/incomplete-coverage',
      evidence: { is_multi_region: false, is_logging: true, has_log_validation: true },
      remediation_ticket_id: null,
      created_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      updated_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      _isDemo: true,
    },
    {
      ...
      resource_type: 'AWS::IAM::User',
      region: 'global',
      resource_arn: 'arn:aws:iam::123456789012:user/demo-developer',
      details: { check_name: 'IAM Access Key Rotation', resource_type: 'IAM', region: 'global', key_age_days: 127 },
      status: 'open',
      source: 'security-engine',
      scan_type: 'deep',
      service: 'IAM',
      category: 'Identity & Access',
      compliance: ['CIS 1.4', 'NIST IA-5', 'PCI-DSS 8.2.4'],
      remediation: 'Rotacionar as access keys e implementar política de rotação automática a cada 90 dias.',
      risk_vector: 'identity/stale-credentials',
      evidence: { key_age_days: 127, last_used: new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000).toISOString() },
      remediation_ticket_id: null,
      created_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      updated_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      _isDemo: true,
    },
    {
      ...
      azure_credential_id: null,
      severity: 'medium',
      title: 'Lambda function sem VPC configurada',
      description: 'A função Lambda demo-api-handler não está configurada dentro de uma VPC, podendo acessar recursos públicos sem controle de rede.',
      resource_id: 'demo-api-handler',
      resource_type: 'AWS::Lambda::Function',
      region: 'us-east-1',
      resource_arn: 'arn:aws:lambda:us-east-1:123456789012:function:demo-api-handler',
      details: { check_name: 'Lambda VPC Configuration', resource_type: 'Lambda', region: 'us-east-1' },
      status: 'open',
      source: 'security-engine',
      scan_type: 'deep',
      service: 'Lambda',
      category: 'Network Security',
      compliance: ['Well-Architected SEC05'],
      remediation: 'Configurar a função Lambda para executar dentro de uma VPC com subnets privadas e security groups adequados.',
      risk_vector: 'network/no-vpc',
      evidence: { vpc_config: null, runtime: 'nodejs18.x', memory_mb: 256 },
      remediation_ticket_id: null,
      created_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      updated_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      _isDemo: true,
    },
    {
      ...
      title: 'EBS Volume sem tags de identificação',
      description: 'O volume vol-demo-data não possui tags para identificação de owner e projeto.',
      resource_id: 'vol-demo-data-2',
      resource_type: 'AWS::EC2::Volume',
      region: 'us-east-1',
      resource_arn: 'arn:aws:ec2:us-east-1:123456789012:volume/vol-demo-data-2',
      details: { check_name: 'Resource Tagging', resource_type: 'EC2', region: 'us-east-1' },
      status: 'open',
      source: 'security-engine',
      scan_type: 'deep',
      service: 'EC2',
      category: 'Governance',
      compliance: ['Well-Architected COST02'],
      remediation: 'Adicionar tags obrigatórias: Owner, Project, Environment, CostCenter.',
      risk_vector: 'governance/missing-tags',
      evidence: { tags: {} },
      remediation_ticket_id: null,
      created_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      updated_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
    ...
    },
    {
      ...
      azure_credential_id: null,
      severity: 'low',
      title: 'S3 Bucket sem versionamento habilitado',
      description: 'O bucket demo-logs não possui versionamento habilitado, dificultando recuperação de dados deletados acidentalmente.',
      resource_id: 'demo-logs',
      resource_type: 'AWS::S3::Bucket',
      region: 'us-east-1',
      resource_arn: 'arn:aws:s3:::demo-logs',
      details: { check_name: 'S3 Bucket Versioning', resource_type: 'S3', region: 'us-east-1' },
      status: 'open',
      source: 'security-engine',
      scan_type: 'deep',
      service: 'S3',
      category: 'Data Protection',
      compliance: ['CIS 2.1.3', 'Well-Architected REL09'],
      remediation: 'Habilitar versionamento no bucket para proteção contra exclusão acidental de objetos.',
      risk_vector: 'data/no-versioning',
      evidence: { versioning_status: 'Disabled' },
      remediation_ticket_id: null,
      created_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      updated_at: new Date(now.getTime() - 2 * 60 * 60 * 1000).toISOString(),
      _isDemo: true,
...
export default {
  ...
  generateDemoSecurityScansTable,
  generateDemoFindingsTable,
};
