...
import { isOrganizationInDemoMode, generateDemoMonitoredResources, generateDemoResourceMetrics, generateDemoEdgeServicesTable, generateDemoEdgeMetricsTable, generateDemoAlertRules } from '../../lib/demo-data-service.js';
...
export async function handler(
  ...
  try {
    ...
    // ============================================
    const DEMO_SUPPORTED_TABLES = new Set(['monitored_resources', 'resource_metrics', 'edge_services', 'edge_metrics', 'alert_rules']);
