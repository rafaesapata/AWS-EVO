...
exports.handler = async (event) => {
  const prisma = new PrismaClient({
    datasources: {
      db: {
        url: 'postgresql://postgres:#c}T4K-:MJ$gkt7yQdhnrQrk+D_}LBW_@evoudsdevelopmentdatabasestack-databaseb269d8bb-aphazcwwiawf.csno4kowwmc9.us-east-1.rds.amazonaws.com:5432/evouds?schema=public'
      }
    }
  });
  ...
  try {
    ...
    // Aplicar migração das tabelas RI/SP usando raw SQL
    const migrations = [
