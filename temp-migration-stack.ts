...
export class TempMigrationStack extends cdk.Stack {
...
exports.handler = async (event) => {
  const client = new Client({
    host: 'evoudsdevelopmentdatabasestack-databaseb269d8bb-aphazcwwiawf.csno4kowwmc9.us-east-1.rds.amazonaws.com',
    port: 5432,
    user: 'postgres',
    password: '#c}T4K-:MJ$gkt7yQdhnrQrk+D_}LBW_',
    database: 'evouds',
  });
  ...
  try {
    ...
    // Aplicar migração das tabelas RI/SP
    const migrations = [
