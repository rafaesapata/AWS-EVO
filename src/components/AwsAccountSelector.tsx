        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div className={cn(
              ...
              {/* Icon with status */}
              <div className="relative">
                <div className="p-2.5 rounded-lg bg-gradient-to-br from-orange-500/20 to-amber-500/20">
              ...
              <div className="flex flex-col min-w-0">
                ...
                <span className="text-[11px] text-muted-foreground font-mono">
                  {accounts[0].account_id || 'AWS Account'}
                </span>
              </div>
            </div>
          </TooltipTrigger>
          <TooltipContent side="bottom" className="max-w-xs p-3">
            <div className="space-y-2">
              ...
              <div className="pl-6 space-y-1">
                <p className="text-sm">{accounts[0].account_name}</p>
                {accounts[0].account_id && (
                  <p className="text-xs text-muted-foreground font-mono">ID: {accounts[0].account_id}</p>
                )}
              </div>
              {accounts[0].regions && accounts[0].regions.length > 0 && (
