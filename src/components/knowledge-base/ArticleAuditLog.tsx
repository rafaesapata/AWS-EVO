    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[80vh]">
        <DialogHeader>
          ...
          <DialogDescription>
            Histórico completo de acessos ao artigo
          </DialogDescription>
        </DialogHeader>
          ...
          {isLoading ? (
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <div className="flex items-center gap-4 text-xs text-muted-foreground">
                      {log.reading_time_seconds && (
                        <span>
                          Tempo de leitura: {Math.floor(log.reading_time_seconds / 60)}m {log.reading_time_seconds % 60}s
                        </span>
                      )}
            ...
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p className="text-xs mt-1">
                O histórico será exibido quando o artigo for visualizado
              </p>
            </div>
          )}
        </ScrollArea>
