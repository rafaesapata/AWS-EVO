...
export function AzureActivityLogs() {
 ...
 <p className="text-2xl font-semibold text-red-500">{data.summary.byRiskLevel.critical}</p>
 </div>
 ...
 <p className="text-2xl font-semibold text-orange-500">{data.summary.byRiskLevel.high}</p>
 </div>
 ...
 <p className="text-2xl font-semibold text-yellow-500">{data.summary.byRiskLevel.medium}</p>
 </div>
 ...
 <p className="text-2xl font-semibold text-green-500">{data.summary.byRiskLevel.low}</p>
 </div>
