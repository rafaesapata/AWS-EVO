    ...
    <Card className="h-full card-hover-lift card-shine">
      <CardHeader>
        <div className="flex items-center gap-2">
          <DollarSign className="h-5 w-5 text-primary icon-bounce" />
          <CardTitle>{t('executiveDashboard.financialHealth', 'Financial Health')}</CardTitle>
        </div>
        <CardDescription>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Progress 
            ...
            className="h-2 progress-shimmer"
          />
        ...
        <div className="border-t pt-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-4 animate-stagger">
            <div className="p-3 rounded-lg bg-blue-500/10 border border-blue-500/20 transition-all hover:scale-[1.02] hover:shadow-md">
            ...
            <div className="p-3 rounded-lg bg-green-500/10 border border-green-500/20 transition-all hover:scale-[1.02] hover:shadow-md glow-success">
          ...
          <div className="flex items-center justify-between p-3 rounded-lg bg-green-500/5 border border-green-500/20 glow-success transition-all hover:scale-[1.01]">
          ...
          <p className="text-xs text-amber-600 flex items-start gap-1 alert-pulse">
