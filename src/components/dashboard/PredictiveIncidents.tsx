...
export default function PredictiveIncidents() {
 ...
 <h2 className="text-2xl font-semibold">Predição de Incidentes (ML)</h2>
 ...
 <CardContent>
 <div className="text-2xl font-semibold tabular-nums">{incidents?.length || 0}</div>
 </CardContent>
 </Card>
 <Card className=" ">
 <CardHeader className="pb-2">
 ...
 <CardContent>
 <div className="text-2xl font-semibold text-destructive tabular-nums">{highRiskCount}</div>
 </CardContent>
 </Card>
 <Card className=" ">
 <CardHeader className="pb-2">
