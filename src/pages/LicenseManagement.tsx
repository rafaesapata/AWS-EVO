...
export default function LicenseManagement() {
 ...
 <TabsList className={`bg-gray-100 grid w-full ${isAdmin ? 'grid-cols-2' : 'grid-cols-1'}`}>
 ...
 <span className="text-3xl font-semibold">{realUsedSeats}</span>
 ...
 <span className={`font-semibold text-lg ${license.days_remaining < 30 ? "text-destructive" : "text-green-600"}`}>
