...
export default function AuthSimple() {
  ...
  return (
    <div className="min-h-[133.33vh] min-h-[133.33dvh] bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 flex items-center justify-center p-4 relative overflow-hidden">
