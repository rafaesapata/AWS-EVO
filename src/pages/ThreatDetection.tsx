...
export default function ThreatDetection() {
 ...
 <AlertTriangle className={`h-4 w-4 text-destructive ${criticalFindings > 0 ? '' : ''}`} />
 </CardHeader>
 <CardContent>
 <div className={`text-2xl font-semibold tabular-nums ${criticalFindings > 0 ? 'text-red-500' : ''}`}>{criticalFindings}</div>
 ...
 <Users className={`h-4 w-4 text-yellow-500 ${highRiskUsers > 0 ? '' : ''}`} />
 </CardHeader>
 <CardContent>
 <div className={`text-2xl font-semibold tabular-nums ${highRiskUsers > 0 ? 'text-yellow-500' : ''}`}>{highRiskUsers}</div>
 ...
 <Network className={`h-4 w-4 text-primary ${activeLateralMovements > 0 ? '' : ''}`} />
 </CardHeader>
 <CardContent>
 <div className={`text-2xl font-semibold tabular-nums ${activeLateralMovements > 0 ? 'text-orange-500' : ''}`}>{activeLateralMovements}</div>
 ...
 className={finding.severity_label === 'Critical' ? '' : ''}
 >
 ...
 <Badge variant="destructive" className="">{detection.severity.toUpperCase()}</Badge>
 </div>
 <div className="space-y-1">
