...
exports.BedrockAI = exports.bedrockAI = void 0;
...
const initializeBedrockClient = async () => {
    ...
    bedrockClient = new client_bedrock_runtime_1.BedrockRuntimeClient(clientConfig);
    clientInitialized = true;
    return bedrockClient;
};
class BedrockAI {
    async invokeModel(modelId, messages, maxTokens = 4000, temperature = 0.7) {
        try {
            ...
            const command = new client_bedrock_runtime_1.ConverseCommand(converseParams);
    ...
    async generateAnalysis(prompt, context) {
        ...
        const response = await this.invokeModel('anthropic.claude-3-5-sonnet-20240620-v1:0', messages, 4000, 0.3);
    ...
    async generateQuickResponse(prompt) {
        ...
        const response = await this.invokeModel('anthropic.claude-3-haiku-20240307-v1:0', messages, 2000, 0.5);
        return response.content;
    }
...
Format the response in clear, actionable sections.`;
    ...
    async generateSecurityAnalysis(securityFindings) {
...
Focus on actionable insights and business impact.`;
    ...
    async generateWellArchitectedAnalysis(architectureData) {
...
Format as a comprehensive report with executive summary.`;
    ...
    async generateRemediationScript(findings, scriptType = 'terraform') {
...
${scriptType === 'terraform' ? 'Use Terraform HCL with latest AWS provider.' :
    ...
    async generateFinOpsInsights(financialData) {
...
Include specific metrics and KPIs where possible.`;
    ...
    async generateIncidentPredictions(metricsData) {
...
Focus on proactive measures and business continuity.`;
    ...
    async generateKnowledgeBaseContent(topic, context) {
...
exports.BedrockAI = BedrockAI;
exports.bedrockAI = new BedrockAI();
