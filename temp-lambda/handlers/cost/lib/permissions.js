...
exports.ROLE_PERMISSIONS = {
    super_admin: Object.keys(exports.PERMISSIONS),
    admin: [
        // Security
...
function getPermissionsByCategory(userRole) {
...
function requirePermission(permission) {
    return function (target, propertyKey, descriptor) {
        ...
        descriptor.value = async function (event, context, middleware) {
            ...
            if (!hasPermission(userRole, permission)) {
                return {
                    ...
                    body: JSON.stringify({
                        ...
                        required: permission,
                        description: exports.PERMISSIONS[permission],
                    }),
                };
            }
                ...
                return {
                    ...
                    body: JSON.stringify({
                        ...
                        description: 'One of the following permissions is required: ' +
                            permissions.map(p => exports.PERMISSIONS[p]).join(', '),
                    }),
                };
            }
            return originalMethod.call(this, event, context, middleware);
