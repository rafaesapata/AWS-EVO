...
async function handler(event, context) {
    logging_js_1.logger.info('🚀 Predict Incidents started');
    ...
    try {
        ...
        logging_js_1.logger.info(`✅ Generated ${predictions.length} incident predictions`);
        ...
        logging_js_1.logger.error('❌ Predict Incidents error:', err);
        return (0, response_js_1.error)(err instanceof Error ? err.message : 'Internal server error');
    }
}
//# sourceMappingURL=predict-incidents.js.map