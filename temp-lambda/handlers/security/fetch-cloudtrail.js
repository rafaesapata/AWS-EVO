...
async function handler(event, context) {
    ...
    try {
        ...
        if (!awsCredential) {
            return (0, response_js_1.error)('AWS Credential not found', 404, undefined, origin);
        }
        // Assume role
        ...
        const cloudTrailClient = new client_cloudtrail_1.CloudTrailClient({ region: 'us-east-1', credentials });
        // Construir filtros
        ...
        // Buscar eventos
        const response = await cloudTrailClient.send(new client_cloudtrail_1.LookupEventsCommand({
        ...
        logging_js_1.logger.error('Fetch CloudTrail error:', error);
...
//# sourceMappingURL=fetch-cloudtrail.js.map