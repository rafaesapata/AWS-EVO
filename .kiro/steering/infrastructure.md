...
| **Endpoint** | `evo-uds-v3-sandbox-postgres.csno4kowwmc9.us-east-1.rds.amazonaws.com` |
| **Database** | `evouds` |
| **Username** | `evoadmin` |
...
```
postgresql://evoadmin:%29V7%3F9ygLec%3FAMSqn%29.UIU4%24vOfRl%2C%24%5EL@evo-uds-v3-sandbox-postgres.csno4kowwmc9.us-east-1.rds.amazonaws.com:5432/evouds?schema=public
```
