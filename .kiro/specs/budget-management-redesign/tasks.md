...
- [ ] 1. Refatorar handler `manage-cloud-budget`
  - [ ] 1.1 Adicionar action `get_current` ao handler `backend/src/handlers/cost/manage-cloud-budget.ts`
  ...
  - [ ] 1.2 Ajustar action `save` para sempre usar year_month do mês corrente
  ...
  - [ ]* 1.3 Escrever property tests para `manage-cloud-budget`
...
- [ ] 2. Criar handler `ai-budget-suggestion`
  - [ ] 2.1 Criar `backend/src/handlers/cost/ai-budget-suggestion.ts`
  ...
  - [ ]* 2.2 Escrever property test para fórmula da sugestão IA
...
- [ ] 4. Redesenhar frontend `BudgetManagement`
  - [ ] 4.1 Criar componentes de resumo do orçamento
  ...
  - [ ] 4.2 Criar componente de input de orçamento com slider
  ...
  - [ ]* 4.3 Escrever property test para sincronização input/slider
    - **Property 7: Sincronização bidirecional input/slider**
    - **Validates: Requirements 2.3, 2.4**

  - [ ] 4.4 Implementar botão e painel de Sugestão IA
  ...
  - [ ] 4.5 Reescrever página `BudgetManagement.tsx`
...
- [ ] 5. Integração e multi-tenancy
  - [ ] 5.1 Verificar isolamento multi-tenant
  ...
  - [ ]* 5.2 Escrever teste de integração multi-tenant
